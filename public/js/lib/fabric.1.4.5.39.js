...
fabric.Collection = {
    ...
    /**@mt*/
    getObjectByID  : function( type ) {
        if ( typeof type === 'undefined' ) {
            return null;
        }
        return this._objects.filter( function( o ) {
            return o.objectID === parseInt( type );
        } );
    },
    getHelpers     : function( type ) {
        if ( typeof type === 'undefined' ) {
            return null;
        }
        return this._objects.filter( function( o ) {
            return o.setHelper === type;
        } );
    },
    getIgnoreSnap  : function( type ) {
        if ( typeof type === 'undefined' ) {
            return null;
        }
        return this._objects.filter( function( o ) {
            return o.ignoreSnap === type;
        } );
    },
    /**
...
(function( global ) {
    ...
    function normalizeValue ( attr, value, parentAttributes, fontSize ) {
        ...
        else if ( attr === 'setHelper' ) {
            value = (value === 'true') ? true : false;
        }
        else if ( attr === 'ignoreSnap' ) {
            value = (value === 'true') ? true : false;
        }
        else if ( attr === 'setBlocker' ) {
            value = (value === 'true') ? true : false;
        }
        else {
    ...
    fabric.parseSVGDocument = (function() {
        ...
        return function( doc, callback, reviver ) {
            ...
            if ( doc.getAttribute( 'originX' ) ) {
                options.originX = doc.getAttribute( 'originX' );
            }
            if ( doc.getAttribute( 'originY' ) ) {
                options.originY = doc.getAttribute( 'originY' );
            }
            ...
            var elements = descendants.filter( function( el ) {
                ...
                return reAllowedSVGTagNames.test( el.tagName ) && ! hasAncestorWithNodeName( el, reNotAllowedAncestors ); // http://www.w3.org/TR/SVG/struct.html#DefsElement
            } );
        ...
        loadSVGFromString : function( string, callback, reviver ) {
            ...
            if ( typeof DOMParser !== 'undefined' ) {
                ...
                if ( parser && parser.parseFromString ) {
                    string = fabric.util.string.escapeXmlSVG( string );
    ...
    fabric.Gradient = fabric.util.createClass( /** @lends fabric.Gradient.prototype */ {
        ...
        toSVG    : function( object ) {
            ...
            for ( var i = 0; i < this.colorStops.length; i ++ ) {
                if ( (typeof this.setHelper === 'undefined' || ! this.setHelper) && typeof isFrontEndUser !== 'undefined' ) {
                    markup.push(
                            //jscs:disable validateIndentation
                            '<stop ',
...
(function() {
     ...
     * }, canvas.renderAll.bind(canvas));
        ...
        _realizeGroupTransformOnObject : function( instance ) {
            var layoutProps = [
                'angle', 'flipX', 'flipY', 'height', 'left', 'scaleX', 'scaleY', 'top', 'width',
                'originX', 'originY'
            ];
     ...
     * });
        ...
        toSVG : function( options, reviver ) {
            ...
            if(typeof allowBackgroundPdf !=='undefined' && Boolean(allowBackgroundPdf))
        ...
        /**mt sendBackwards**/
        sendBackwardsGroup      : function( object, intersecting, groupID ) {
            var idx = this._objects.indexOf( object );

            // if object is not on the bottom of stack
            if ( idx !== 0 ) {
                var newIdx = this._findNewLowerIndexGroup( object, idx, intersecting, groupID );
                removeFromArray( this._objects, object );
                this._objects.splice( newIdx, 0, object );
                this.renderAll && this.renderAll();
            }
        ...
        /**mt */
        _findNewLowerIndexGroup : function( object, idx, intersecting, groupID ) {
            var newIdx;
        ...
        /**
         * @mt bringForward group
         */
        bringForwardGroup       : function( object, intersecting, groupID ) {
            var idx = this._objects.indexOf( object );
            // if object is not on top of stack (last item in an array)
            if ( idx !== this._objects.length - 1 ) {
                var newIdx = this._findNewUpperIndexGroup( object, idx, intersecting, groupID );
                removeFromArray( this._objects, object );
                this._objects.splice( newIdx, 0, object );
                this.renderAll && this.renderAll();
            }
        ...
        /**
         * @mt _findNewUpperIndexGroup
         */
        _findNewUpperIndexGroup : function( object, idx, intersecting, groupID ) {
            var newIdx;
            if ( intersecting ) {
                newIdx = idx;
...
(function() {
    ...
    fabric.Canvas = fabric.util.createClass( fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
        ...
        _rotateObject : function( x, y ) {
            ...
            if ( typeof shiftKeyPressed !== 'undefined' && shiftKeyPressed ) {
                switch ( true ) {
                    case (radiansToDegrees( curAngle ) > 0 && radiansToDegrees( curAngle ) < 15):
                        t.target.angle = 90;
                        break;
                    case (radiansToDegrees( curAngle ) > 15 && radiansToDegrees( curAngle ) < 30):
                        t.target.angle = 105;
                        break;
                    case (radiansToDegrees( curAngle ) > 30 && radiansToDegrees( curAngle ) < 45):
                        t.target.angle = 120;
                        break;
                    case (radiansToDegrees( curAngle ) > 45 && radiansToDegrees( curAngle ) < 60):
                        t.target.angle = 135;
                        break;
                    case (radiansToDegrees( curAngle ) > 60 && radiansToDegrees( curAngle ) < 75):
                        t.target.angle = 150;
                        break;
                    case (radiansToDegrees( curAngle ) > 75 && radiansToDegrees( curAngle ) < 90):
                        t.target.angle = 165;
                        break;
                    case (radiansToDegrees( curAngle ) > 90 && radiansToDegrees( curAngle ) < 105):
                        t.target.angle = 180;
                        break;
                    case (radiansToDegrees( curAngle ) > 105 && radiansToDegrees( curAngle ) < 120):
                        t.target.angle = 195;
                        break;
                    case (radiansToDegrees( curAngle ) > 120 && radiansToDegrees( curAngle ) < 135):
                        t.target.angle = 210;
                        break;
                    case (radiansToDegrees( curAngle ) > 135 && radiansToDegrees( curAngle ) < 150):
                        t.target.angle = 225;
                        break;
                    case (radiansToDegrees( curAngle ) > 150 && radiansToDegrees( curAngle ) < 165):
                        t.target.angle = 240;
                        break;
                    case (radiansToDegrees( curAngle ) > 165 && radiansToDegrees( curAngle ) < 180):
                        t.target.angle = 255;
                        break;
                    case (radiansToDegrees( curAngle ) < 0 && radiansToDegrees( curAngle ) > - 15):
                        t.target.angle = 75;
        ...
        //@mt find targets
        findAllTarget      : function( e, skipGroup ) {
            if ( this.skipTargetFind ) {
                return;
            }
            ...
            var target = this._searchAllPossibleTargets( e );
            return target;
        },
        /**
         * @private
        ...
        _searchPossibleTargets    : function( e, skipGroup ) {
            ...
            while ( i -- ) {
                if ( (! this._objects[i].group || skipGroup) && this._checkTarget( e, this._objects[i], pointer ) ) {
                    ...
                    if ( typeof this._objects[i].setHelper == 'undefined' ) {
                        target = this._objects[i];
                        break;
                    }
                    else if ( this._objects[i].setHelper != true ) {
                        target = this._objects[i];
                        break;
                    }
                }
        ...
        /** @mt search all posible targets*/
        _searchAllPossibleTargets : function( e ) {
            ...
            while ( i -- ) {
                if ( ! this._objects[i].group && this._checkTarget( e, this._objects[i], pointer ) ) {
                    if ( typeof this._objects[i].setHelper == 'undefined' && typeof isFrontEndUser !== 'undefined' ) {
                        this.relatedTarget = this._objects[i];
                        target.push( this._objects[i] );
                    }
                    else if ( this._objects[i].setHelper != true ) {
                        this.relatedTarget = this._objects[i];
                        target.push( this._objects[i] );
...
(function() {
    ...
    fabric.util.object.extend( fabric.Canvas.prototype, /** @lends fabric.Canvas.prototype */ {
        ...
        __onMouseDown : function( e ) {
            ...
            this.fire( 'before:mouse:down', { target : target, e : e } );
            ...
            if ( ! isRightClick ) {
                ...
                if ( target.length > 0 ) {
                    ...
                    div.id = 'contextMenuCanvasRightClick';
                    div.className = 'dropdown  clearfix';
                    div.innerHTML = '<ul class="dropdown_menu_canvas select_shape_from_canvas" role="menu" aria-labelledby="dropdownMenu" style="display:block;position:static;margin-bottom:5px;z-index=1000;"></ul>';
                    target.forEach( function( val, key ) {
                        div.firstElementChild.innerHTML += '<li class="select_option_drop_down_canvas" data-type="' + val.objectID + '">Shape ' + (key + 1) + '</li><li class="divider"></li>';
                    } );
                    div.innerHTML += '</ul>';
...
(function( global ) {
    ...
    fabric.Object = fabric.util.createClass( /** @lends fabric.Object.prototype */ {
         ...
         * @default
         */
        borderColor : 'rgba(20,152,253,0.75)',
         ...
         * @default
         */
        cornerColor : 'rgba(20,152,253,0.75)',
        ...
        transform : function( ctx, fromLeft ) {
            ...
            var center = fromLeft ? this._getLeftTopCoords() : this.getCenterPoint2();
        ...
        toObject : function( propertiesToInclude ) {
            var NUM_FRACTION_DIGITS = fabric.Object.NUM_FRACTION_DIGITS,
                    ...
                    object = {
                        ...
                        setHelper                : typeof this.setHelper !== 'undefined' ? this.setHelper : false,
        ...
        _renderControls : function( ctx, noTransform ) {
            ...
            center = fabric.util.transformPoint( centerPoint, vpt, null != this.group );
            if ( this.group ) {
     ...
     * });
         ...
         * develop by mt for snap to object by
         *
         */
        setHelperDesign       : function( helper ) {
            this.set( 'setHelper', helper );
            return this;
        },
        setSnapedLeft         : function( snap ) {
            this.set( 'snapLeft', snap );
            return this;
        },
        setSnapedLeftInside   : function( snap ) {
            this.set( 'snapLeftInside', snap );
            return this;
        },
        setSnapedRight        : function( snap ) {
            this.set( 'snapRight', snap );
            return this;
        },
        setSnapedRightInside  : function( snap ) {
            this.set( 'snapRightInside', snap );
            return this;
        },
        setSnapedTop          : function( snap ) {
            this.set( 'snapTop', snap );
            return this;
        },
        setSnapedTopInside    : function( snap ) {
            this.set( 'snapTopInside', snap );
            return this;
        },
        setSnapedBottom       : function( snap ) {
            this.set( 'snapBottom', snap );
            return this;
        },
        setSnapedBottomInside : function( snap ) {
            this.set( 'snapBottomInside', snap );
            return this;
        },
        setSnapedCanvasV      : function( snap ) {
            this.set( 'snapCanvasV', snap );
            return this;
        },
        setSnapedCanvasH      : function( snap ) {
            this.set( 'snapCanvasH', snap );
            return this;
        },
        getDesignerOptions:function(){
            return this.designerOptions;
        },
        /*set designer Options
        * @params: {String} key Key of propriety
        * @params: {Object} object Object Data
        * */
        setDesignerOptions:function(key,object){
            this.set(key,object);
            return this;
        },
        /**
...
(function() {
    ...
    fabric.util.object.extend( fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        getCenterPoint : function() {
            ...
            if(typeof this.cropObjectData !=='undefined' && typeof (this.cropObjectData['xMiddlePoint'])!=='undefined' && (this.cropObjectData['yMiddlePoint'])!=='undefined'){

                var  pos1       = new fabric.Point( this.left, this.top );

                var transformMatrix = this._calcDimensionsTransformMatrix();

                var points = fabric.util.transformPoint( {x:this.cropObjectData['xMiddlePoint'],y:this.cropObjectData['yMiddlePoint']}, transformMatrix, true );

                var  origpos1   = this.translateToCenterPoint( pos1, this.originX, this.originY );

                if (this.flipX && this.flipY ){

                    leftTop         = new fabric.Point( origpos1.x - points.x, origpos1.y - points.y );
                }
                else
                if (this.flipX && !this.flipY ){
                    leftTop         = new fabric.Point( origpos1.x - points.x, origpos1.y + points.y );
        ...
        setPositionByOrigin : function( pos, originX, originY ) {
            ...
            if(this.getCropObjectData('widthCrop')){
                var transformMatrix = this._calcDimensionsTransformMatrix();
                var pointss         = fabric.util.transformPoint( {x:this.cropObjectData['xMiddlePoint'],y:this.cropObjectData['yMiddlePoint']}, transformMatrix, true );
                var tt={};
                if(!this.flipX && !this.flipY){
                    tt.x                = position.x-pointss.x;
                    tt.y                = position.y-pointss.y;
                }else{
                    if(!this.flipX && this.flipY){
                        tt.x                = position.x-pointss.x;
                        tt.y                = position.y+pointss.y;
...
fabric.util.object.extend( fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
    ...
    getSvgTransform : function() {
        ...
        var toFixed = fabric.util.toFixed,
                angle = this.getAngle(),
                vpt = ! this.canvas || this.canvas.svgViewportTransformation ? this.getViewportTransform() :
                      [1, 0, 0, 1, 0, 0],
                center = fabric.util.transformPoint( this.getCenterPoint2(), vpt ),
     ...
     * @returns {value}
     */
    getCropObjectData : function( name ) {
      if(typeof this.cropObjectData === 'undefined' || (typeof this.cropObjectData[name] !=='undefined' && this.cropObjectData[name]==null)){
          return null;
      }
      if(typeof this.cropObjectData[name] ==='undefined')
        return null;
      return this.cropObjectData[name];
    },
...
(function() {
    ...
    fabric.util.object.extend( fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        _getNonTransformedDimensions : function() {
            ...
            if(typeof (this.getClipTo()) === 'function'){
                if(typeof this.cropObjectData !=='undefined') {
                     w = this.cropObjectData['widthCrop'];
                     h = this.cropObjectData['heightCrop'];
                }
            }
            if ( vLine ) {
                w = strokeWidth;
...
(function( global ) {
    ...
    fabric.Group = fabric.util.createClass( fabric.Object, fabric.Collection, /** @lends fabric.Group.prototype */ {
        ...
        toSVG      : function( reviver ) {
            ...
            for ( var i = 0, len = this._objects.length; i < len; i ++ ) {
                if ( typeof this._objects[i].setHelper === 'undefined' || ! this._objects[i].setHelper ) {
...
(function( global ) {
    ...
    fabric.Image = fabric.util.createClass( fabric.Object, /** @lends fabric.Image.prototype */ {
        ...
        toObject : function( propertiesToInclude ) {
            ...
            var object = extend( this.callSuper( 'toObject', propertiesToInclude ), {
                src         : this._originalElement != null ? (this._originalElement.src || this._originalElement._src) : null,
                filters     : filters,
            ...
            if ( (typeof this.setHelper === 'undefined' || ! this.setHelper) && typeof isFrontEndUser !== 'undefined' ) {
                ...
                if(this.clipTo){
                    markup.push(
                            ...
                            '<rect ',
                            'x="', this.getCropObjectData('xCrop') , '" y="',  this.getCropObjectData('yCrop'),
                            '" width="', this.getCropObjectData('widthCrop'), '" height="', this.getCropObjectData('heightCrop'),
                            '" ',
                            '/>\n',
                            '</clipPath>\n',
                            '</g>\n'
                    ...
                    isCliped=true;
                    clipString='clip-path="url(#ClipPath_' + this.objectID + ')"';
                }
...
(function( global ) {
    ...
    fabric.Text = fabric.util.createClass( fabric.Object, /** @lends fabric.Text.prototype */ {
        ...
        _initDimensions : function( ctx ) {
            ...
            if ( this.curvedText ) {
                ...
                this.height = parseInt( ((this.radius + this.fontSize) * 2) );
                this.width = parseInt( (this.radius + this.fontSize) * 2 );
            }
        },
        ...
        _renderCurvedText  : function( method, ctx, chars, left, top, lineIndex ) {
            var curAngle = 180, angleRadians = 0, align = 0, charOffset = 0, toDraw = [
            ], angleOffset = 0, workingRadius = 0, lineOffset = 0;
        ...
        _getSVGCurvedTextAndBg : function( markup ) {
            var textSpans = [],
                    ...
                    height = 0,
                    curAngle = 180, angleRadians = 0, align = 0, charOffset = 0, toDraw = [
                    ], angleOffset = 0, workingRadius = 0, lineOffset = 0, left = 0, top = 0, rotation = 0;
            this.render( ctx );
            this._setTextStyles( ctx );
            for ( var i = 0, len = this._textLines.length; i < len; i ++ ) {
                toDraw = [];
    ...
    fabric.Text.fromElement = function( element, options ) {
        ...
        var textContent = element.textContent.replace( /^\s+|\s+$|\n+/g, '' ).replace( /\s+/g, ' ' ),
                text = new fabric.IText( textContent, options ),
        /*
         Adjust positioning:
...
(function() {
    ...
    fabric.IText = fabric.util.createClass( fabric.Text, fabric.Observable, /** @lends fabric.IText.prototype */ {
        ...
        renderCursor : function( boundaries, ctx ) {
            ...
            if ( this.curvedText == true ) {
                // var popupTemplate="<div><input type='text' style='' value='"+this.text+"'></div>";
                //  $(popupTemplate)
            }
            else {
